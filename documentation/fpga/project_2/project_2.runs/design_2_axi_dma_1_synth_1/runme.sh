...
HD_PWD='/home/emg2-abtics/project_2/project_2.runs/design_2_axi_dma_1_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log design_2_axi_dma_1.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source design_2_axi_dma_1.tcl
