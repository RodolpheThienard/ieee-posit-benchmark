...
__attribute__((sdx_kernel("add", 0))) void add(data_h in_a, data_h in_b, data_h out_c);
# 4 "posit_hls/add.c" 2

__attribute__((sdx_kernel("add", 0))) void add(data_h in_a, data_h in_b, data_h out_c)
{
#line 18 "/home/emg2-abtics/posit_hls/solution1/csynth.tcl"
#pragma HLSDIRECTIVE TOP name=add
# 6 "posit_hls/add.c"

#line 7 "/home/emg2-abtics/posit_hls/solution1/directives.tcl"
#pragma HLSDIRECTIVE TOP name=add
# 6 "posit_hls/add.c"
