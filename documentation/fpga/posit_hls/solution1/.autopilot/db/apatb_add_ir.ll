...
define void @apatb_add_ir(float %in_a, float %in_b, float %out_c) local_unnamed_addr #0 {
entry:
  call fastcc void @copy_in()
  call void @apatb_add_hw(float %in_a, float %in_b, float %out_c)
  call void @copy_back()
  ret void
}
...
declare void @apatb_add_hw(float, float, float)
...
define void @add_hw_stub_wrapper(float, float, float) #3 {
entry:
  call void @copy_out()
  call void @add_hw_stub(float %0, float %1, float %2)
  call void @copy_in()
  ret void
}

declare void @add_hw_stub(float, float, float)
