...
#ifndef RacEr_CUDA_LITE_RUNTIME_H_
#define RacEr_CUDA_LITE_RUNTIME_H_
...
INIT_TILE_GROUP_BARRIER(main_r_barrier, main_c_barrier, 0, RacEr_tiles_X-1, 0, RacEr_tiles_Y-1);
*/
...
//           RacEr_tile_group_barrier(&main_r_barrier, &main_c_barrier);         \
